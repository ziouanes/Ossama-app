        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">قائمة السيارات</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices')) }}">قائمة السيارات في
                            المستودع</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}">قائمة السيارات في
                            المعطلة</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}"> قائمة السيارات تتطلب
                            اصلاح
                        </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}">الفواتير المدفوعة
                            جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Archive')) }}">أرشيف السيارات</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">أقسم الاعطال </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">أنواع الاعطال</a></li>
                </ul>
            </li>
        </ul>
    </div>
